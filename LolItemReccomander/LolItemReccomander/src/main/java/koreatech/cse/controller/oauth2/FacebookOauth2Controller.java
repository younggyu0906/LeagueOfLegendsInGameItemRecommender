...
public class FacebookOauth2Controller {
    private static String facebook_client_id = "564083267390128";      //본인 것으로 추가하기
    private static String facebook_client_secret = "032c0aea8a79706103dc33cf8d119fd3";  //본인 것으로 추가하기
